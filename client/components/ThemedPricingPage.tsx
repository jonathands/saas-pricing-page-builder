...
export function ThemedPricingPage({ children, className = '' }: ThemedPricingPageProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`themed-pricing-page min-h-full bg-gradient-to-br ${theme.backgroundColor}`}>
        {children}
      </div>
    </div>
  );
