            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                ...
                <p className="text-xs text-blue-600">
                  This is a demonstration checkout. Card number field only
                  accepts zeros (0000...). No real payment processing.
                </p>
              </div>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                <p className="text-sm text-amber-800">
                  <strong>🎭 Demo Checkout:</strong> This is a demonstration
                  only. No real payment will be processed. The card number field
                  accepts only zeros to emphasize this is a mockup.
                </p>
              </div>
            </div>
          )}
...
export function PricingPagePreview({
  ...
  const [selectedStrategy, setSelectedStrategy] =
    useState<PricingModel | null>(null);

  const handleGetStarted = (plan: any, strategy: PricingModel) => {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Add a pricing model to see the pricing page preview
            </p>
          </div>
        </div>
      </div>
        ...
        {strategies.map((strategy) => (
          <div key={strategy.id} className="space-y-8">
            ...
            {strategy.type === "flat-rate" && (
              <FlatRatePricingCard
                strategy={strategy as FlatRateModel}
            ...
            {strategy.type === "tiered" && (
              <TieredPricingCards
                strategy={strategy as TieredModel}
                onGetStarted={handleGetStarted}
                theme={theme}
              />
            )}
            ...
            {strategy.type === "usage-based" && (
              <UsageBasedPricingCard
                strategy={strategy as UsageBasedModel}
                onGetStarted={handleGetStarted}
                theme={theme}
              />
            )}
            ...
            {strategy.type === "per-user" && (
              <PerUserPricingCard
                strategy={strategy as PerUserModel}
                onGetStarted={handleGetStarted}
                theme={theme}
              />
            )}
            ...
            {strategy.type === "freemium" && (
              <FreemiumPricingCards
                strategy={strategy as FreemiumModel}
                onGetStarted={handleGetStarted}
                theme={theme}
              />
            )}
            ...
            {strategy.type === "feature-based" && (
              <FeatureBasedPricingCard
                strategy={strategy as FeatureBasedModel}
                onGetStarted={handleGetStarted}
                theme={theme}
              />
            )}
...
function FeatureBasedPricingCard({ strategy, onGetStarted, theme }: any) {
  ...
  const mandatoryTotal = mandatoryFeatures.reduce(
        ...
        <CardContent className="space-y-4">
          ...
          <div className="border-t pt-3">
            ...
            >
              ...
              <span className="text-lg" style={{ color: theme.primaryColor }}>
                ${totalPrice}/
